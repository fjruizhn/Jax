...
**No hay nada roto.** El backend responde, CORS está correcto, el JWT se genera. Abrí el browser en `https://axioma-ia.io` ahora mismo — debería entrar sin problema con `fernando@rich-hn.com` / `JAX2026!`.
